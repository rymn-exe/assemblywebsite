...
const Hero: React.FC = () => {
  return (
    <section className="hero" style={{ textAlign: 'center', backgroundColor: '#fff', border: 'var(--manual-border)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="hero-inner" style={{ padding: '100px 40px', position: 'relative', zIndex: 1 }}>
        <h1 className="hero-title" style={{ fontSize: '4.5rem', marginBottom: '10px', fontWeight: 900 }}>Assembly Süggested</h1>
        ...
        <p className="hero-steps" style={{ fontSize: '3.5rem', fontWeight: 900, marginBottom: '40px', letterSpacing: '0.05em', lineHeight: 1.1, marginTop: '2px' }}>
          26 SIMPLE STEPS
        </p>
        <div className="hero-dates" style={{ marginBottom: '50px', borderTop: '1px solid #000', borderBottom: '1px solid #000', display: 'inline-block', padding: '20px 40px' }}>
